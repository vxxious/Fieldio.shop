...
export const regionOptions: ReadonlyArray<RegionOption> = [
  ...
  { code: "AO", currency: "AOA", defaultLanguage: "en" },
  ...
  { code: "BR", currency: "BRL", defaultLanguage: "en" },
  ...
  { code: "IT", currency: "EUR", defaultLanguage: "en" },
  ...
  { code: "PT", currency: "EUR", defaultLanguage: "en" },
