    ...
    <>
      ...
      <header className="site-header">
        <div className="header-left">
          <button ref={menuButtonRef} className="icon-button mobile-only" type="button" onClick={() => setMenuOpen(true)} aria-label="Open menu" aria-expanded={menuOpen}><MenuIcon /></button>
